registerPaint(
  ...
  class {
    ...
    paint(ctx, geom, properties) {
      console.log("tile-size", properties.get("--circles-tile-size"));
      console.log("colors", properties.get("--circles-colors"));
      console.log("amplitude", properties.get("--circles-amplitude"));
      console.log("blend-mode", properties.get("--circles-blend-mode"));

      const tileSize = parseInt(properties.get("--circles-tile-size"));
      const colors = this.convertColorList(
        properties.get("--circles-colors").toString()
      );
